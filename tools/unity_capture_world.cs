...
internal class CommandScript:IRunCommand {
 public void Execute(ExecutionResult result){
  ...
  camera.transform.position=new Vector3(-43,7,-3);camera.transform.LookAt(new Vector3(53,22,0));HNP.Editor.HnpWorldBuilder.Capture(camera,1440,900,Path.Combine(root,"reports/world/approach.png"));
  ...
  var game=UnityEngine.Object.FindFirstObjectByType<HnpWorldGame>();if(game&&Application.isPlaying){game.Begin();game.ReturnToStation();}
