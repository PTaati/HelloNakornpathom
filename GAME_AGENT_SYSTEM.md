...
เอกสารอ้างอิงที่แยกแล้ว: [รายละเอียดเกม Markdown](Game-Hello%20Nakornpathom.md), [ภาพแผนที่จาก Word](ref/game-document/README.md), [ข้อกำหนดผังตามคำอธิบายผู้ใช้](docs/design/MAP_LAYOUT.md) — สถานีฝั่งซ้าย ออกสู่ถนนกลางแล้วตรงไปองค์พระ ข้อมูลสำรวจด้านล่างเป็นสถานะตอนจัดทำแบบครั้งแรก; ผลทดลองเกมล่าสุดดู `reports/prototype-validation.md`
